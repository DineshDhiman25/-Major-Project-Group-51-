...
def main():
    ...
    # To package result: zip -r hermes_final.zip /kaggle/working/openhermes-finetuned-final
    print("Done. To package: zip -r hermes_final.zip /kaggle/working/openhermes-finetuned-final")
